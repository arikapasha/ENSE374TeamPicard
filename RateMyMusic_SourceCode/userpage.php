...
$user = $_SESSION["username"];
        ...
        $q = " SELECT * FROM rate WHERE rate.user = '$user' ORDER BY id DESC LIMIT 5";
...
<p><a href = "search.html"><button type="button" id = "but9"> Rate Music Now </button></a></p>
<div id = "but10"><?php echo $_SESSION['username'];?></div>
<a href = "all.php"><div id = "but14"><h5>View All</h5></div></a>

<div id = "but17"><h2>Your Recent Ratings</h2></div>
